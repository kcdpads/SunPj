			...
			<div class="row"> 
				<div class="col-sm-6" style="margin-left: 300px;">
					<div class="box">
						<h2>DESIGNER EDIT</h2>
						<br>
						<form name="addDesignerForm" id="addDesigner" action="updateDesignerSubmit.do"
							class="register-form inputs-border inputs-bg" method="post"
							enctype="multipart/form-data">
							<table>
								<tr>
									<td rowspan="6"><input type="file" name='photo'
										onchange="readURL(this);" style='display: none' /> <img src="${designerInfo.designerPhoto}"
