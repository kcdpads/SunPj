...
<H2 text align="center">공지사항게시판(전체 글:${count})</H2>
...
<table class="table table-hover">
  ...
  <c:if test="${article.re_level == 0}">
    <img src="images/level.gif" width="${5 * article.re_level}" height="16">
      ...
      <a href="noticeContent.do?noticeNo=${article.noticeNo}&pageNum=${currentPage}">
          ${article.noticeTitle}</a>
         <c:if test="${article.noticeHits >= 20}">
...
<div align="right">
<a class="btn-default" href="noticewriteForm.do">글쓰기</a></div></c:if>
